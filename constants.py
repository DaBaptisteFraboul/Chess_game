...
image_pin = pygame.image.load("assets/board/export/Pinned_square.png")
image_pin = pygame.transform.scale(image_pin, (64,64))
image_pin_direction = pygame.image.load("assets/board/export/Pinned_direction_square.png")
image_pin_direction = pygame.transform.scale(image_pin_direction, (64,64))
image_check =  pygame.image.load("assets/board/export/Checking_square.png")
image_check = pygame.transform.scale(image_check, (64,64))
board_offset = (64, 128)
